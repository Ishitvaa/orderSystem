...
import com.phegondev.InventoryMgtSystem.dtos.OrderItemDTO;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Response createOrder(CreateOrderRequest request) {
        ...
        Order order = Order.builder()
                ...
                .shippingCost(request.getShippingCost() != null ?
                        request.getShippingCost() : BigDecimal.ZERO)
        ...
        // 6. Process order items and calculate totals
        ...
        for (OrderItemDTO itemDTO : request.getOrderItems()) {
            ...
            BigDecimal itemDiscount = itemDTO.getDiscount() != null ?
                    itemDTO.getDiscount() : BigDecimal.ZERO;
    ...
    public Response getAllOrders(String filter) {
        ...
        List<OrderDTO> orderDTOs = modelMapper.map(orders,
            ...
            orderDTOs = orderDTOs.stream()
                    .filter(o ->
                        (o.getOrderNumber() != null &&
                            o.getOrderNumber().toLowerCase().contains(lowerFilter)) ||
                        (o.getOrderStatus() != null &&
                            o.getOrderStatus().toString().toLowerCase()
                                .contains(lowerFilter)) ||
                        (o.getPaymentStatus() != null &&
                            o.getPaymentStatus().toString().toLowerCase()
                                .contains(lowerFilter)) ||
                        (o.getCustomer() != null &&
                            o.getCustomer().getFirstName() != null &&
                            o.getCustomer().getFirstName().toLowerCase()
                                .contains(lowerFilter)) ||
                        (o.getCustomer() != null &&
                            o.getCustomer().getLastName() != null &&
                            o.getCustomer().getLastName().toLowerCase()
                                .contains(lowerFilter))
                    )
                    .toList();
        }
    ...
    public Response getOrderById(Long id) {
        ...
        if (orderDTO.getUser() != null) {
            orderDTO.getUser().setTransactions(null);
        }
        if (orderDTO.getCustomer() != null) {
            orderDTO.getCustomer().setOrders(null);
        }
