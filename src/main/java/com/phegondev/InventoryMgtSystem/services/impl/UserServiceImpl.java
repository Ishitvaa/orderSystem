...
public class UserServiceImpl implements UserService {
    ...
    public Response registerUser(RegisterRequest registerRequest) {
        ...
        return Response.builder().status(200).message("User was successfully registered").build();
    }
    ...
    public Response loginUser(LoginRequest loginRequest) {
        ...
        return Response.builder().status(200).message("User Logged in Successfully")
                .role(user.getRole()).token(token).expirationTime("6 months").build();
    }
    ...
    public Response updateUser(Long id, UserDTO userDTO) {
        ...
        return Response.builder().status(200).message("User successfully updated").build();
    }
    ...
    public Response deleteUser(Long id) {
        ...
        return Response.builder().status(200).message("User successfully Deleted").build();
    }
    ...
    public Response getUserTransactions(Long id) {
        ...
        if (userDTO.getTransactions() != null) {
            userDTO.getTransactions().forEach(t -> { t.setUser(null); t.setSupplier(null); });
        }
        return Response.builder().status(200).message("success").user(userDTO).build();
    }
}