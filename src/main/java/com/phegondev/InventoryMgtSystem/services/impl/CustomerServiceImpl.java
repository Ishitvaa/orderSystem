...
public class CustomerServiceImpl implements CustomerService {
    ...
    public Response addCustomer(CustomerDTO customerDTO) {
        ...
        return Response.builder().status(200).message("Customer Added Successfully").build();
    }
    ...
    public Response getAllCustomers() {
        ...
        return Response.builder().status(200).message("success").customers(customerDTOs).build();
    }
    ...
    public Response getCustomerById(Long id) {
        ...
        return Response.builder().status(200).message("success").customer(customerDTO).build();
    }
    ...
    public Response updateCustomer(Long id, CustomerDTO customerDTO) {
        ...
        if (customerDTO.getCompanyName() != null) existingCustomer.setCompanyName(customerDTO.getCompanyName());
        if (customerDTO.getCustomerType() != null) existingCustomer.setCustomerType(customerDTO.getCustomerType());
        if (customerDTO.getNotes() != null) existingCustomer.setNotes(customerDTO.getNotes());
        if (customerDTO.getIsActive() != null) existingCustomer.setIsActive(customerDTO.getIsActive());
        customerRepository.save(existingCustomer);
        return Response.builder().status(200).message("Customer Updated Successfully").build();
    }
    ...
    public Response deleteCustomer(Long id) {
        ...
        return Response.builder().status(200).message("Customer Deleted Successfully").build();
    }

    @Override
    public Response searchCustomers(String searchValue) {
        List<Customer> customers = customerRepository
                .findByFirstNameContainingOrLastNameContaining(searchValue, searchValue);
        customers.forEach(customer -> customer.setOrders(null));
        List<CustomerDTO> customerDTOs = modelMapper.map(customers, new TypeToken<List<CustomerDTO>>() {}.getType());
        return Response.builder().status(200).message("success").customers(customerDTOs).build();
    }
