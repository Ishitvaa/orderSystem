...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Response createCategory(CategoryDTO categoryDTO) {
        ...
        return Response.builder().status(200).message("Category Saved Successfully").build();
    }
    ...
    public Response getAllCategories() {
        ...
        return Response.builder().status(200).message("success").categories(categoryDTOList).build();
    }
    ...
    public Response updateCategory(Long id, CategoryDTO categoryDTO) {
        ...
        return Response.builder().status(200).message("Category Was Successfully Updated").build();
    }
    ...
    public Response deleteCategory(Long id) {
        ...
        return Response.builder().status(200).message("Category Was Successfully Deleted").build();
    }
}